...
typedef enum{
	LEVEL_ZERO = 7,//安全等级0，当一个服务不需要安全解锁时，使用此安全等级。	0111
	LEVEL_ONE = 1,//安全等级1，当一个服务可以在安全等级1时，使用此安全等级。	0001
	LEVEL_TWO = 2,//安全等级2，当一个服务可以在安全等级2时，使用此安全等级。	0010
	LEVEL_THREE = 4,//安全等级3，当一个服务可以在安全等级3时，使用此安全等级	0100
	LEVEL_FOUR = 8,//安全等级4，工厂模式会话使用此安全等级，零部件商下线配置.	1000
	LEVEL_UNSUPPORT = 0,//不支持，当一个服务在某个会话模式不支持时，使用此等级。0000
